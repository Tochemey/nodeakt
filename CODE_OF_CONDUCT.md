...
The community moderators for this project are the **GoAkt Team**.

When an incident does occur, it is important to report it promptly. To report a possible violation, contact the GoAkt Team **in private**:

- Email a repository owner or listed maintainer using the address on their GitHub profile. Put **Code of Conduct** in the subject line, and include what happened, where (for example a pull request, issue, or discussion), when, and who was involved, as far as you can.
- Do **not** open a public GitHub issue, discussion, or pull-request comment about the incident.
