...
First release of NodeAkt, a zero-dependency actor runtime for Node.js, Bun, and Deno. An actor owns private state and a mailbox; the runtime delivers one message at a time.
